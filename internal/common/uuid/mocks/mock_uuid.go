...
// Source: github.com/KirkDiggler/ronnied/internal/common/uuid (interfaces: UUID)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=mocks/mock_uuid.go github.com/KirkDiggler/ronnied/internal/common/uuid UUID
//
